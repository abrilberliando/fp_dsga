...
<div style="margin:.5rem 0 1.2rem 0;">
    <span class="pill pill-green">Gemini 2.5 Flash</span>
    <span class="pill pill-blue">Google AI</span>
    <span class="pill pill-orange">XGBoost Integration</span>
</div>
...
with tab_wf:
    ...
    st.markdown(f"""
<div class="kpi-wrap kpi-green" style="padding:1.5rem;">
<div style="display:flex; justify-content:space-around; align-items:center;
            flex-wrap:wrap; gap:1rem; text-align:center; font-size:.82rem;">
    <div><div style="font-size:2rem;">📋</div><b>User Input</b><br>
         <span style="color:{C['muted']}">Kategori, Stok<br>Kadaluarsa, Harga</span></div>
    <div style="color:{C['muted']}; font-size:1.3rem;">→</div>
    <div><div style="font-size:2rem;">🌳</div><b>XGBoost</b><br>
         <span style="color:{C['muted']}">ML Prediction<br>Risk Score</span></div>
    <div style="color:{C['muted']}; font-size:1.3rem;">→</div>
    <div><div style="font-size:2rem;">⚠️</div><b>Risk Analysis</b><br>
         <span style="color:{C['muted']}">Probability<br>Risk Level</span></div>
    <div style="color:{C['muted']}; font-size:1.3rem;">→</div>
    <div><div style="font-size:2rem;">✨</div><b>Gemini LLM</b><br>
         <span style="color:{C['muted']}">NL Analysis<br>Chat Context</span></div>
    <div style="color:{C['muted']}; font-size:1.3rem;">→</div>
    <div><div style="font-size:2rem;">💼</div><b>Recommendation</b><br>
         <span style="color:{C['muted']}">Actionable<br>Business Advice</span></div>
</div>
</div>
""", unsafe_allow_html=True)

    st.markdown("<br>", unsafe_allow_html=True)
    section_header("🏗️ Architecture Layers")
    col_ml, col_llm = st.columns(2)
    with col_ml:
        st.markdown(f"""
<div class="ibox green">
<b>📊 Machine Learning Layer</b><br><br>
Model: <b>XGBoost Classifier</b><br>
Task: Binary Classification (was_spoiled)<br>
Input: 30+ product features<br>
Output: Risk Probability (0–100%)<br>
Balancing: SMOTE
</div>
""", unsafe_allow_html=True)
    with col_llm:
        st.markdown(f"""
<div class="ibox blue">
<b>🤖 LLM Layer (Gemini)</b><br><br>
Model: <b>Gemini 2.5 Flash</b><br>
Task: NL recommendation generation<br>
Input: ML predictions + product context<br>
Output: Laporan + Chat responses<br>
